...
const CreatePost = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div>
        <h1 className="font-extrabold text-[#223328] text-[32px]">Create</h1>
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        ...
        <div className="mt-10">
          <p className="mt-5 text-[14px] text-[#666e75]">
            Once you have created the image you want, you can share it with
            others in the community
          </p>
          <button
            className="mt-2 text-white bg-blue-700 font-medium rounded-md text-sm w-full sm:w-auto px-5 py-2.5 text-center"
            type="submit"
          >
